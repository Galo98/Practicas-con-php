        ...
        <section class="productos">
            ...
            <div class="productos__contenedor-resultados">
                <div class="productos__busqueda">
                    <form class="productos__busqueda-form" action="busqueda.php" method="POST">
                ...
                <div class="productos__contenedor-articulos">
                    <?php while($dato = mysqli_fetch_assoc($consulta)){ ?>
                        <article class="productos__articulo">
                            ...
                            <div class="productos__articulo-contenedorBtn">
                                <form action="modificar.php" method="POST">
                                    <input type="hidden" name="id" value=<?php echo $dato['pid']; ?> >
                                    <button class="productos__articulo-btn-m">Modificar</button>
                                </form>
                                <form action="eliminar.php" method="POST">
                                    <input type="hidden" class="oculto" name="id" value=<?php echo $dato['pid']; ?> >
                                    <button class="productos__articulo-btn-e">Eliminar</button>
                                </form>
                            </div>
                        </article>
                    <?php } ?>
